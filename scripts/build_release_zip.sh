...
for path in requirements.txt .env.example core/service.py config/caption_templates.pagasa.json config/content_composer.json config/image_rendering.json services/map_framing_service.py; do
